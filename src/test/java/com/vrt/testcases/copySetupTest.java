...
public class copySetupTest extends BaseClass {
	...
	@Test(groups = { "Regression" }, description = "CS001-Verify if the validation message is displayed when only one asset exists and clicked on copy button")
	public void CS001() throws InterruptedException, ParseException, IOException, AWTException {

		extentTest = extent.startTest("CS001-Verify if the validation message is displayed when only one asset exists and clicked on copy button");
	...
	//CS011-Verify if information related to the Setups inside of the table is correct
...
// Define Setup
	...
	// CS013-Verify if the _Filter_ functionality is implemented in each column but _Selected_
	...
	public void CS013( String SetupName,
			String SensorCount, String comment, String TempCount, String TCSensorLabel, String Qstart)
			throws InterruptedException, IOException, AWTException, ParseException {
		extentTest = extent
	...
	@Test(groups = { "Regression" }, description = "CS014-Verify if the _Copy_ button on _Copy Setup_ page is visible but if no one setup file is selected, should show message _Please select at least one setup to copy_")
	public void CS014() throws InterruptedException, ParseException, IOException, AWTException {

		extentTest = extent.startTest("CS014-Verify if the _Copy_ button on _Copy Setup_ page is visible but if no one setup file is selected, should show message _Please select at least one setup to copy_");
		SoftAssert sa = new SoftAssert();
	...
	// CS015-Verify if single or multiple Setups selection can be done on _Copy Setup_ screen
	// CS016-Verify if only selected setups files are copied to the Asset
	//This CS016 test case also covered under CS015.
	
	@Test(groups = { "Regression" }, description = "CS015A-Verify if single Setups selection can be done on _Copy Setup_ screen")
	...
	//CS015B-Verify if single or multiple Setups selection can be done on _Copy Setup_ screen
	
		@Test(groups = { "Regression" }, description = "CS015B-Verify if multiple Setups selection can be done on _Copy Setup_ screen")
    ...
    //CS017-Verify if selecting the file (s) and clicking on _Copy_ button invokes _Do you want to copy the setup(s)_ with -Yes- and -No- buttons.
		...
		@Test(groups = { "Regression" }, description = "CS017-Verify if selecting the file (s) and clicking on _Copy_ button invokes _Do you want to copy the setup(s)_ with -Yes- and -No- buttons.")
		public void CS017() throws InterruptedException, ParseException, IOException, AWTException {

			extentTest = extent.startTest("CS017-Verify if selecting the file (s) and clicking on _Copy_ button invokes _Do you want to copy the setup(s)_ with -Yes- and -No- buttons.");
			SoftAssert sa = new SoftAssert();
			...
			sa.assertEquals(ActcopysetupAlert, ExpAlrtMsg,"Fail : Actual Alert message is not match with expected alert contain");
			sa.assertAll();
			
		}
		
	//CS018-Verify if clicking -Yes- invokes -Enter user Credentials- box. and clicking No will not perform copy operation	
		@Test(groups = { "Regression" }, description = "CS018A-Verify if clicking -Yes- invokes -Enter user Credentials- box. and clicking No will not perform copy operation")
		public void CS018A() throws InterruptedException, ParseException, IOException, AWTException {

			extentTest = extent.startTest("CS018A-Verify if clicking -Yes- invokes -Enter user Credentials- box. and clicking No will not perform copy operation");
			SoftAssert sa = new SoftAssert();
			...
			CopySetuppage.click_copy_Btn();
			CopySetuppage.select_alertOption("Yes");
			sa.assertEquals(CopySetuppage.UserLoginPopupVisible(), true, 
					"FAIL: pop up not visible");		
			sa.assertAll();
		
			
		}
		//CS018B-Verify if clicking -Yes- invokes -Enter user Credentials- box. and clicking No will not perform copy operation	
				@Test(groups = { "Regression" }, description = "CS018B-Verify if clicking -NO- invokes -Enter user Credentials- box. and clicking No will not perform copy operation")
				public void CS018B() throws InterruptedException, ParseException, IOException, AWTException {

					extentTest = extent.startTest("CS018B-Verify if clicking -NO- invokes -Enter user Credentials- box. and clicking No will not perform copy operation");
					SoftAssert sa = new SoftAssert();
					...
					sa.assertEquals(CopySetuppage.Copysetup_btn_IsEnable(), true, 
							"FAIL: pop up not visible");		
					sa.assertAll();
	...
	//CS022-Verify if Audit trail captures the name of the setup that was copied, along with user id and user name, and date_time			
				...
				@Test(groups = { "Regression" }, description = "CS019,CS020,CS021-Verify the setup is copied to the correct selected location for Copy")
				public void CS019() throws InterruptedException, ParseException, IOException, AWTException {

					extentTest = extent.startTest("CS019,CS020,CS021-Verify the setup is copied to the correct selected location for Copy");
					SoftAssert sa = new SoftAssert();
				    ...
				    String sname =	assetDetailsPage.Get_Setup_Name();
					sa.assertEquals(selectedSetupFile, sname,"Fail :  Copied file is not  available at the Asset details setups screen");
					assetHubPage = assetDetailsPage.ClickBackBtn();
					MainHubPage = assetHubPage.click_BackBtn();
	...
	//CS021-Verify if the same setup can be copied to the same location multiple times
				@Test(groups = { "Regression" }, description = "CS021-Verify if the same setup can be copied to the same location multiple times")
				public void CS021() throws InterruptedException, ParseException, IOException, AWTException {

					extentTest = extent.startTest("CS021-Verify if the same setup can be copied to the same location multiple times");
					SoftAssert sa = new SoftAssert();
					...
					sa.assertEquals(ActcopysetupAlert, ExpAlrtMsg,"Fail : overwrite Alert message is not match with expected alert contain");
					sa.assertAll();
	...
	// CS005-Verify if the numbers of the Setup files in each Assets are displayed correctly
