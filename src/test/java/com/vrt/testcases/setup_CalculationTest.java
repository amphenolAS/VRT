...
//CAL032-Verify that the drop down of Saturation temperature of steam will display the list of all Pressure sensors
	...
	public void CAL033() throws InterruptedException, IOException {
		...
		Setup_GroupSensorsPage = Setup_SensorConfigPage.Click_yes_Alert();
		Setup_GroupSensorsPage.click_DfltGrp_Btn();
		Setup_CalculationsPage = Setup_GroupSensorsPage.Click_NxtBtn();
		Setup_CalculationsPage.click_SatTP_btn();
...
//CAL038-Verify that on-click of the Qualification Parameters navigator on the top right will navigate to Qualification Parameters screen
	...
	//CAL040-Verify the bottom menu options displayed in Qualification Parameters screen

	@Test(description = "CAL040-Verify the bottom menu options displayed in Qualification Parameters screen")
	public void SC106()
			throws InterruptedException {
		extentTest = extent.startTest("CAL040-Verify the bottom menu options displayed in Qualification Parameters screen");
		SoftAssert sa = new SoftAssert();
	...
	public void CAL041()
		...
		extentTest = extent.startTest("CAL041-Verify that on-click of home btn in bottom menu options is navigated to main hub page");
		SoftAssert sa = new SoftAssert();
	...
	public void CAL042()
			throws InterruptedException {
		extentTest = extent.startTest("CAL042-Verify that on-click of help btn in bottom menu options displays information about the Qualification parameters screen");
		SoftAssert sa = new SoftAssert();
		
		Setup_CalculationsPage.Click_Help_Icon_AppBar();
		
		sa.assertEquals(Setup_CalculationsPage.get__HelpMenu_HdrText(), 
				"Calculations", "FAIL: Clicking Help icon/button in bottom app bar"
						+ "do not display the Calculations Help context window");
		sa.assertAll();
	}

	//CAL043-Verify that on-click of windows help btn in bottom menu options generates a PDF with information
   ...
   //CAL044-Verify that on-click of About btn in bottom menu options displays the software version and the console IP address
	...
	public void SC110()
			throws InterruptedException {
		extentTest = extent.startTest("'CAL044-Verify that on-click of About btn in bottom menu options displays the software version and the console IP address");
		SoftAssert sa = new SoftAssert();
		
		Setup_CalculationsPage.Click_About_Icon_AppBar();		
		sa.assertEquals(Setup_CalculationsPage.check_About_wndw_Presence(), 
