...
public class setup_SensorConfigTest extends BaseClass {
	...
	@Test(groups = {
			"Regression" }, description = "SC032-Verify the details displayed under Configure sensors section")
	...
	public void SC070() throws InterruptedException, ParseException, IOException {
		...
		sa.assertEquals(Setup_SensorDescriptionPage.IsSensorDescriptionTitle_Visible(), true, "FAIL: Sensor Description Title is not Visible");
		sa.assertEquals(Setup_SensorDescriptionPage.IsSelectSensorTypeByHeader_Visible(), true, "FAIL:Select  Sensor Type By  header is not Visible");
		sa.assertEquals(Setup_SensorDescriptionPage.IsPageCloseIcon_Visible(), true, "FAIL: close button is not Visible");	
		sa.assertAll();
	}

//SC071-Verify that on the left pane the sensor descriptions are displayed along with other details in Description screen
	@Test(groups = { "Regression" }, description = "SC071-Verify that on the left pane the sensor descriptions are displayed along with other details in Description screen")

	public void SC071() throws InterruptedException, ParseException, IOException {
		extentTest = extent.startTest("SC071-Verify that on the left pane the sensor descriptions are displayed along with other details in Description screen");
		SoftAssert sa = new SoftAssert();
		Setup_SensorConfigPage.Click_Addsensors_Expanderbtn();
		Setup_SensorConfigPage.Enter_TemperatureCount_textField("1");
		Setup_SensorConfigPage.Click_Configurationsensors_Expanderbtn();
		...
		sa.assertEquals(Setup_SensorDescriptionPage.IsSerialNo_field_Visible(), true, "FAIL: Serial number is not found");
	...
	//SC072-Verify that on the right pane the selection and description of the sensors are assigned in Description screen
		@Test(groups = { "Regression" }, description = "SC072-Verify that on the right pane the selection and description of the sensors are assigned in Description screen")

		public void SC072() throws InterruptedException, ParseException, IOException {
			extentTest = extent.startTest("SC072-Verify that on the right pane the selection and description of the sensors are assigned in Description screen");
			SoftAssert sa = new SoftAssert();
			Setup_SensorConfigPage.Click_Addsensors_Expanderbtn();
			Setup_SensorConfigPage.Enter_TemperatureCount_textField("1");
			Setup_SensorConfigPage.Click_Temp_sensor();
			...
			sa.assertEquals(Setup_SensorDescriptionPage.is_SensorType_ComboBoxVisible(), true, "FAIL: SensorType ComboBox is not Visible");
			sa.assertEquals(Setup_SensorDescriptionPage.is_From_textVisible(), true, "FAIL: Fromtext ComboBox is not Visible");

			sa.assertEquals(Setup_SensorDescriptionPage.is_To_textVisible(), true, "FAIL: Totext range ComboBox is not Visible");
			
			sa.assertEquals(Setup_SensorDescriptionPage.IsRightpane_Description_field_Visible(), true, "FAIL: Description_Txtfield is not Visible");
			
			sa.assertEquals(Setup_SensorDescriptionPage.Is_SensorLabelAutoNumber_checked(), false, "FAIL: SensorLabelAutoNumber is not checked");
			
			sa.assertEquals(Setup_SensorDescriptionPage.IsOk_buttonVisible(), true, "FAIL: Description_Txtfield is not Visible");
			
			
			sa.assertEquals(Setup_SensorDescriptionPage.IsClose_buttonVisible(), true, "FAIL: Description_Txtfield is not Visible");
  ...
  //SC074-Verify that the sensor type drop down displays Pressure only  in Description screen when Pressure sensors are added
	...
	// pane and it should reflect range as 1 to 1 on right pane in Description screen
	@Test(groups = {
...
//Enter 2 chars 
		...
		sa.assertEquals(FromVal_SD, ToVal, "Fail: From value in SD page is not displaying  the entered to value in SC page");
...
//Enter 4 chars 
 ...
 //SC080-Verify that when a greater value is entered in From field than the To field the OK button is disabled and a validation message is displayed in Description screen
	...
	public void SC080() throws InterruptedException, ParseException, IOException, AWTException {
		...
		sa.assertEquals(ActAlrtMsg, ExpAlrtMsg, "FAIL: Error message is not displayed when when a greater value is entered in From field than the To field");
...
public void SC082(String FromText ) throws InterruptedException, IOException, AWTException, ParseException {
  ...
  //SC083-Verify the invalid inputs in Range- First text box in Description screen
...
@Test( groups = {
		"Regression" }, description = "SC083A-Enter only space in From field and verify the Assign button")
...
@Test(groups = { "Regression" }, description = "SC084_1A-Enter only space in From field and verify the Assign button")
...
public void SC084_1B() throws InterruptedException, IOException, AWTException, ParseException {
	extentTest = extent.startTest("SC083B - Enter the value in to field more than defined in the Add sensors section");
	SoftAssert sa = new SoftAssert();
...
@Test(groups = { "Regression" }, description = "SC085-Verify the max number of characters allowed in Description field")
...
extentTest = extent
	.startTest("SC086-Verify the inputs in Description field");
SoftAssert sa = new SoftAssert();
...
Setup_SensorDescriptionPage.clickOk();
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row1(),Description,"Description accepting more than 23 charatecrs");
...
extentTest = extent
	.startTest("SC087-Verify that by manually selecting the sensors on the left pane and entering the description on the right pane will assign to the selected sensors on the left pane");
SoftAssert sa = new SoftAssert();
...
public void SC088() throws InterruptedException, IOException, AWTException, ParseException {
    ...
    Thread.sleep(1000);
	sa.assertEquals(Setup_SensorDescriptionPage.is_From_textEnable(), false,"From field on the right pane is not disable");
	sa.assertEquals(Setup_SensorDescriptionPage.is_To_textEnable(), false, "To field on the right pane is not disable");
...
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row1(),"ABC1","Description text is not matching in first row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row2(),"ABC2","Description text is not matching is not matching in second row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row3(),"ABC3","Description text is not matching is not matching in third row");
...
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row2(),"ABC2","Description text is not matching in second row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row5(),"ABC1","Description text is not matching is not matching with fifth row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row8(),"ABC3","Description text is not matching is not matching in eight row");
...
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row2(),"ABC2","Description text is not matching is not matching in second row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row3(),"ABC3","Description text is not matching is not matching in third row");
sa.assertEquals(Setup_SensorDescriptionPage.Description_txt_Row4(),"ABC4","Description text is not matching is not matching in fourth row");
...
extentTest = extent.startTest("SC092-Verify that a validation message is displayed when trying to add description when no sensor is selected on the left pane and the range fields are empty");
SoftAssert sa = new SoftAssert();
...
sa.assertEquals(defineSetupPage.get_defineSetupPage_Nametext(), "Define Setup", "Fail: Define Setup page Name is not correct");
sa.assertAll();
}
...
Setup_GroupSensorsPage = Setup_SensorConfigPage. Click_nextbtn_withAlert();
sa.assertEquals(Setup_GroupSensorsPage.get_GrpsensorPage_titletext(), "Group Sensors", "Fail: Group Sensors page name is not correct");
sa.assertAll();
}
...
sa.assertEquals(assetDetailsPage.assetDetail_PageTitle(), "HeatBath - Asset01", "Fail: asset Details Page name is not correct");
sa.assertAll();
}
...
public void SC107()
	...
	extentTest = extent.startTest("SC107-Verify that on-click of home btn in bottom menu options is navigated to main hub page");
	SoftAssert sa = new SoftAssert();
...
public void SC108()
		throws InterruptedException {
	extentTest = extent.startTest("SC108-Verify that on-click of help btn in bottom menu options displays information about the Sensor configuration screen");
	SoftAssert sa = new SoftAssert();
	
	Setup_SensorConfigPage.Click_Help_Icon_AppBar();
	
	sa.assertEquals(Setup_SensorConfigPage.get__HelpMenu_HdrText(), 
			"Sensors Configuration", "FAIL: Clicking Help icon/button in bottom app bar"
...
public void SC110()
		throws InterruptedException {
	extentTest = extent.startTest("SC110-Verify that on-click of About btn in bottom menu options displays the software version and the console IP address");
	SoftAssert sa = new SoftAssert();
	
	assetCreationPage.Click_About_Icon_AppBar();		
	sa.assertEquals(Setup_SensorConfigPage.check_About_wndw_Presence(), 
...
@Test(groups = { "Regression" }, description = "SC111-Verify that Auto Numbering field is in Disable Mode as Default")
...
@Test(groups = { "Regression" }, description = "SC112-Verify that Auto Numbering Field should not be in checked when one sensor is selected")

public void SC112() throws InterruptedException, IOException, AWTException, ParseException {
	extentTest = extent.startTest("SC112-Verify that Auto Numbering Field should not be in checked when one sensor is selected");
	SoftAssert sa = new SoftAssert();
...
@Test(groups = { "Regression" }, description = "SC113-Verify that Auto Numbering Field should be in checked when more than one sensor is selected")

public void SC113() throws InterruptedException, IOException, AWTException, ParseException {
	extentTest = extent.startTest("SC113-Verify that Auto Numbering Field should be in checked when more than one sensor is selected");
	SoftAssert sa = new SoftAssert();
...
@Test(groups = { "Regression" }, description = "SC114-Verify that Clear button should be in disable mode when more than one sensor is selected")

public void SC114() throws InterruptedException, IOException, AWTException, ParseException {
	extentTest = extent.startTest("SC114-Verify that Clear button should be in disable mode when more than one sensor is selected");
	SoftAssert sa = new SoftAssert();
...
@Test(groups = { "Regression" }, description = "SC116-Verify that Clear button should be in enable mode when one sensor is selected")

public void SC116() throws InterruptedException, IOException, AWTException, ParseException {
	extentTest = extent.startTest("SC116-Verify that Clear button should be in enable mode when one sensor is selected");
	SoftAssert sa = new SoftAssert();
...
extentTest = extent
	.startTest("SC117-Verify that Description should be clear on clicking on the Clear button when the sensor having the description");
SoftAssert sa = new SoftAssert();
...
extentTest = extent
	.startTest("SC118-Verify that Validation message should be displayed on clicking on the Clear button when the sensor does not having the description");
SoftAssert sa = new SoftAssert();
