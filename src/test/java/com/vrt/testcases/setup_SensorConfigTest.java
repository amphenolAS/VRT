...
public class setup_SensorConfigTest extends BaseClass {
	...
	public void SC001() throws InterruptedException {
		...
		sa.assertEquals(Setup_SensorConfigPage.SensorConfig_assetname_state(), true,
	...
	public void SC002() throws InterruptedException {
		extentTest = extent.startTest(
				"SC002:Verify that sensors pane on the left side will display no sensors and will be blank "
				+ "till no sensor types are defined and selected");
		SoftAssert sa = new SoftAssert();
		...
		sa.assertEquals(actalert, expalert,
				"FAIL: Either some sensors are defined in the Sensor Config page for which the alert message was not displayed to User");
		sa.assertAll();
	}
	...
	@Test(groups = {
			"Regression" }, description = "Verify that on-click of the Down arrow icon for "
					+ "Add Sensors section expands and displays the Sensor types")
	...
	// Add sensors section
	@Test(groups = {
			"Regression" }, dataProvider = "TcSC004", dataProviderClass = setupCreationUtility.class, 
					description = "Verify that max 3 characters are accepted in Temperature field under Add sensors section")
	...
	@Test(groups = {
			"Regression" }, dataProvider = "TcSC005", dataProviderClass = setupCreationUtility.class, 
					description = "Verify the valid inputs accepted in Temperature field under Add Sensors section")
