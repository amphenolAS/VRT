...
public class assetDetailsTest extends BaseClass {
	...
	// EDIT,COPY,DELETE
	@Test(priority=0,groups = { "Regression" }, description = "ASST001-Verify the details displayed in Asset details screen")
	...
	@Test(priority=3,groups = { "Regression" }, description = "ASST003-Verify the on-click functionality of edit icon for Asset")
...
// ASST006-Verify the Back Button functionality in Edit Asset screen
	@Test(priority=5,groups = { "Regression" }, description = "Verify the Back Button functionality in Edit Asset screen")
	...
	@Test(priority=6,groups = { "Regression" }, description = "ASST007-Verify the clear button functionality in Edit Asset screen")
	...
	@Test(priority=8,groups = { "Regression" }, description = "ASST009,ASST022STP-Verify the on-click of Copy icon for Assets")
...
//ASST012-Verify the on-click of Delete icon for Assets which has files in it
	...
	@Test(priority=11,groups = { "Regression" }, description = "ASST014-Verify the details displayed under Setups tile")
	...
	@Test(priority=12,groups = { "Regression" }, description = "ASST015STP-Verify the Setup date and time for a new Setup")
	...
	@Test(priority=13,groups = { "Regression" }, description = "ASST015STP-Verify the Setup date and time for a new Setup")
	...
	@Test(priority=14,groups = { "Regression" }, description = "ASST018STP-Verify on-click of Copy button for a setup")
...
// ASST020STP-Verify -Copy to drive- functionality of a setup for local drive
	...
	@Test(priority=15,groups = { "Regression" }, description = "Verify Copy to drive functionality of a setup for local drive")
	...
	@Test(priority=16,groups = { "Regression" }, description = "Verify the display of Initiate Qualification button in setup tile")
	...
	// ASST024_2ASTP-Verify the filed level validations for Run number field in Initiate qualification pop-up_Invalid Value
...
//ASST026STP-Verify on-click functionality of Edit icon for a setup
	@Test(priority=24,groups = { "Regression" }, description = "ASST026STP-Verify on-click functionality of Edit icon for a setup")
...
//Define Setup
	...
	// ASST039STP-Verify the Audit trail for print Setup report activity (This Test case is covering under ASST037 )
	...
	public void ASST037() throws InterruptedException, IOException, AWTException {
		extentTest = extent.startTest("ASST037,ASST039STP-Verify the on-click functionality of the print icon for a setup");
		SoftAssert sa = new SoftAssert();
	...
	@Test(priority=35,groups = { "Regression" }, description = "ASST043-Verify the details displayed under Qualifications tile")
	...
	// for local drive
	// ASST046-Verify if Audit trial record exists for Copy of a study file (This Test Case is executed under ASST044 )
...
//ASST048-Verify the on-click functionality of generate reports button in Qualification tile
	...
	@Test(priority=41,groups = { "Regression" }, description = "ASST052REP-Verify the details displayed under reports tile")
...
// ASST061REP-Verify if Audit trial record exists for Copy of a Detailed report (This test cases is executing under ASST059REP)
	...
	public void ASST059() throws InterruptedException, IOException, AWTException {
		extentTest = extent
				.startTest("ASST059REP,ASST061REP-Verify -Copy to drive- functionality of a Detailed Report for local drive");
		SoftAssert sa = new SoftAssert();
	...
	// drive
	// ASST064REP-Verify if Audit trial record exists for Copy of a Summary report(This Test Case Executed under )
	...
	@Test(priority=51,groups = { "Regression" }, description = "ASST074-Verify the details displayed under Documents tile")
