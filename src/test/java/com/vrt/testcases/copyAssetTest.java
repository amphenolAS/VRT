...
// Define Setup
	...
	// Application will allow upto 25 chars
		...
		sa.assertEquals(DisplayedAstname.length(), 25,
				"FAIL:Asset name  accepting more than 25 chars");
	...
	public void CA004(String NewAssetName,String NewAssetid) throws InterruptedException, IOException, AWTException, ParseException {
	...
	//This CA005A test case is a part of CA005 test case step
	 ...
	 //CA005A- Keep Asset name field blank and enter valid values in all other fields and save changes
		...
		public void CA005C() throws InterruptedException, IOException, AWTException, ParseException {
			extentTest = extent.startTest(
					"CA005C-Verify when user enter only special charecters to the Asset name field");
			SoftAssert sa = new SoftAssert();
			Copyassetpage = assetDetailsPage.clickCopyasset();
		...
		// Application will allow upto 15 chars
			...
			sa.assertEquals(DisplayedAstID.length(), 15,
					"FAIL: Asset Id accepting more than 15 chars");
	...
	//CA008-Verify the invalid inputs in Asset ID field
		...
		//CA008B-Verify when user enter only special characters to the Asset ID field
         ...
         //CA009-Verify that Asset is copied even when no setups are selected
				@Test(groups = {
						"Regression" }, description = "CA009-Verify that Asset is copied even when no setups are selected")
	...
	//CA010-Verify if clicking on back button in copy asset screen in user navigates to Assets page
		@Test(groups = {"Regression" }, description = "CA010-Verify if clicking on back button in copy asset screen in user navigates to Assets page")

		public void CA010()throws InterruptedException, IOException, AWTException, ParseException {
			extentTest = extent.startTest("CA010-Verify if clicking on back button in copy asset screen in user navigates to Assets page");
			SoftAssert sa = new SoftAssert();
			Copyassetpage = assetDetailsPage.clickCopyasset();
	...
	//CA011-Verify the on-click functionality of the copy button in Copy Asset screen
	//CA014-Verify if Audit trial record exists for copy asset.
	//This Test Case also covered under CA011 
				
	@Test(groups = {"Regression" }, description = "CA011-Verify the on-click functionality of the copy button in Copy Asset screen")

		public void CA011()throws InterruptedException, IOException, AWTException, ParseException {
			extentTest = extent.startTest("CA011-Verify the on-click functionality of the copy button in Copy Asset screen");
			SoftAssert sa = new SoftAssert();
			Copyassetpage = assetDetailsPage.clickCopyasset();
	...
	//CA013-Verify the date and time of the copied setups in the copied Asset	
		...
		@Test(groups = {"Regression" }, description = "CA013-Verify the date and time of the copied setups in the copied Asset	")
	...
	//CA015-Verify user is unable to delete the copied asset if it has any files in it
		...
		public void CA015()throws InterruptedException, IOException, AWTException, ParseException {
			extentTest = extent.startTest("CA015-Verify user is unable to delete the copied asset if it has any files in it");
			SoftAssert sa = new SoftAssert();
	...
	//CA016-Verify user is able to delete the copied asset if it has no files in it	
		...
		public void CA016()throws InterruptedException, IOException, AWTException, ParseException {
			extentTest = extent.startTest("CA016-Verify user is able to delete the copied asset if it has no files in it	");
			SoftAssert sa = new SoftAssert();
