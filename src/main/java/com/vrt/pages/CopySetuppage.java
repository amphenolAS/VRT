...
public class CopySetuppage extends BaseClass {
  ...
  //Login Popup presence 
	...
	public String get_assetname() {
		List<WebElement> Firstastname = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
	...
	public String get_copysetupname() {
		List<WebElement> Firstsetupname = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
	...
	//Fetch the sensor number
		...
		public String get_sensrNumber() {
			List<WebElement> snsrnum = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
		...
		//Fetch comment
				...
				public String get_comment() {
					List<WebElement> comment = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
				    return FetchText(comment.get(5));
				}
				
		//Fetch date
				public String get_date() {
					List<WebElement> setupdate = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
				    return FetchText(setupdate.get(6));
				}
				
		//Is Date displayed		
				public boolean IsdateDisplayed() {
					List<WebElement> date = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
				    return date.get(6).isDisplayed();
				}
			

	public boolean Is_assetnameTiles_Empty() {
		List<WebElement> astlist = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
		return astlist.isEmpty();

	}
	//
	public int SetupCount() {
		List<WebElement> chkbox = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("CheckBox"));
	return chkbox.size();
