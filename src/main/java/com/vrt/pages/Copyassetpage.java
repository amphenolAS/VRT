...
public class Copyassetpage extends BaseClass {
 ...
 //get setup name from copy set up page
		...
		public String get_SETUPname() {
			List<WebElement> setuplist = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
  ...
  // Is check box for each setup is available
	...
	// click on  check box for any setup is available
					...
					{
						List<WebElement> checkboxlist = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("CheckBox"));
