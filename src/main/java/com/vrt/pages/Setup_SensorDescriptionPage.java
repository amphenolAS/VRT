...
public class Setup_SensorDescriptionPage extends BaseClass {
 ...
 //Check Pressure displayed in combo box when only pressure added in Sensor config page
   ...
   //Check humidity displayed in combo box when only humidity added in Sensor config page
    ...
    //Verify that by default first sensor should be selected on the left pane
	 ...
	 List<WebElement> senrList = driver.findElementByAccessibilityId("PART_ScrollViewer").findElement(By.name("TextBlock"));
...
//Click on eight sensor   
     ...
     public String Description_txt_Row1() {
    	 List<WebElement> desclist = driver.findElementByAccessibilityId("PART_ScrollViewer").findElements(By.className("TextBlock"));
