...
/*	public boolean is_1stSensor_selected() {
	...
	*/
	...
	//The list of sensors displayed below the groups on left pane in Group Wiring page
	...
	//List of groups created in group sensors screen on the left pane  in Group Wiring page

	
	public int  countOfgroups() {
		List<WebElement> Groups = driver.findElementByClassName("ListBox")
   ...
   //click on Image2Button
	...
	// click on RemoveImageBtn
				...
				public String  First_groupname() {
					List<WebElement> Groups = driver.findElementByClassName("ListBoxItem")
							.findElements(By.className("TextBlock"));
